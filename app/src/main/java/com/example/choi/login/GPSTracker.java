...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static final long MIN_TIME_BW_UPDATES = 1000 * 30; // 30 초

    // Declaring a Location Manager
    protected LocationManager locationManager; //location 받아올 때 필요함
    ...
    public void onProviderDisabled(String provider) {
        ...
        mHandler.sendEmptyMessage(Next.RENEW_GPS);
